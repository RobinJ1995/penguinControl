...
class AccessListenerTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testHandleWhenTheAccessDecisionManagerDecidesToRefuseAccess ()
	{
		...
		$listener = new AccessListener (
			$context, $accessDecisionManager, $accessMap, $this->getMock ('Symfony\Component\Security\Core\Authentication\AuthenticationManagerInterface')
		);
	...
	public function testHandleWhenTheTokenIsNotAuthenticated ()
	{
		...
		$listener = new AccessListener (
			$context, $accessDecisionManager, $accessMap, $authManager
		);
	...
	public function testHandleWhenThereIsNoAccessMapEntryMatchingTheRequest ()
	{
		...
		$listener = new AccessListener (
			$context, $this->getMock ('Symfony\Component\Security\Core\Authorization\AccessDecisionManagerInterface'), $accessMap, $this->getMock ('Symfony\Component\Security\Core\Authentication\AuthenticationManagerInterface')
		);
	...
	public function testHandleWhenTheSecurityContextHasNoToken ()
	{
		...
		$listener = new AccessListener (
			$context, $this->getMock ('Symfony\Component\Security\Core\Authorization\AccessDecisionManagerInterface'), $this->getMock ('Symfony\Component\Security\Http\AccessMapInterface'), $this->getMock ('Symfony\Component\Security\Core\Authentication\AuthenticationManagerInterface')
		);
