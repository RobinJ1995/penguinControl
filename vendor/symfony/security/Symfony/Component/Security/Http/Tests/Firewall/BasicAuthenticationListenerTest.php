...
class BasicAuthenticationListenerTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testHandleWithValidUsernameAndPasswordServerParameters ()
	{
		...
		$listener = new BasicAuthenticationListener (
			$context, $authenticationManager, 'TheProviderKey', $this->getMock ('Symfony\Component\Security\Http\EntryPoint\AuthenticationEntryPointInterface')
		);
	...
	public function testHandleWhenAuthenticationFails ()
	{
		...
		$listener = new BasicAuthenticationListener (
			$context, new AuthenticationProviderManager (array ($this->getMock ('Symfony\Component\Security\Core\Authentication\Provider\AuthenticationProviderInterface'))), 'TheProviderKey', $authenticationEntryPoint
		);
	...
	public function testHandleWithNoUsernameServerParameter ()
	{
		...
		$listener = new BasicAuthenticationListener (
			$context, $this->getMock ('Symfony\Component\Security\Core\Authentication\AuthenticationManagerInterface'), 'TheProviderKey', $this->getMock ('Symfony\Component\Security\Http\EntryPoint\AuthenticationEntryPointInterface')
		);
	...
	public function testItRequiresProviderKey ()
	{
		new BasicAuthenticationListener (
			$this->getMock ('Symfony\Component\Security\Core\SecurityContextInterface'), $this->getMock ('Symfony\Component\Security\Core\Authentication\AuthenticationManagerInterface'), '', $this->getMock ('Symfony\Component\Security\Http\EntryPoint\AuthenticationEntryPointInterface')
		);
	}
