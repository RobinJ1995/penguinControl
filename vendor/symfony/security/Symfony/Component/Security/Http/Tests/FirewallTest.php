...
class FirewallTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testOnKernelRequestStopsWhenThereIsAResponse ()
	{
		...
		$event = $this->getMock (
			'Symfony\Component\HttpKernel\Event\GetResponseEvent', array ('hasResponse'), array (
	...
	public function testOnKernelRequestWithSubRequest ()
	{
		...
		$event = new GetResponseEvent (
			$this->getMock ('Symfony\Component\HttpKernel\HttpKernelInterface'), $this->getMock ('Symfony\Component\HttpFoundation\Request'), HttpKernelInterface::SUB_REQUEST
		);
